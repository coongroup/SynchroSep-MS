...
for index in range(0,len(prec_pivot.index.get_level_values('Precursor.Id'))):
    print(index)

    
    data = prec_pivot['Precursor.Quantity'][col1_dil].iloc[index]
    pearson_r1 = ignore_na_r2(data.index,data)
    dil_r2_1.append(pearson_r1)

  
    data = prec_pivot['Precursor.Quantity'][col1_inv_dil].iloc[index]
    pearson_r2 = ignore_na_r2(data.index,data)
    inv_r2_1.append(pearson_r2)

    
    data = prec_pivot['Precursor.Quantity'][col2_dil].iloc[index]
    pearson_r1 = ignore_na_r2(data.index,data)
    dil_r2_2.append(pearson_r1)

    
    
    data = prec_pivot['Precursor.Quantity'][col2_inv_dil].iloc[index]
    pearson_r2 = ignore_na_r2(data.index,data)
...
#save r2_calc
dil_r2_1.to_csv('C:/Users/nlancaster/OneDrive - UW-Madison/MultiColumnManuscript/ManuscriptDraft/PythonFigures/IntermediateFiles/int_med_prec_dil_r2_1.csv',index = False)
dil_r2_2.to_csv('C:/Users/nlancaster/OneDrive - UW-Madison/MultiColumnManuscript/ManuscriptDraft/PythonFigures/IntermediateFiles/int_med_prec_dil_r2_2.csv',index = False)
inv_r2_1.to_csv('C:/Users/nlancaster/OneDrive - UW-Madison/MultiColumnManuscript/ManuscriptDraft/PythonFigures/IntermediateFiles/int_med_prec_inv_r2_1.csv',index = False)
inv_r2_2.to_csv('C:/Users/nlancaster/OneDrive - UW-Madison/MultiColumnManuscript/ManuscriptDraft/PythonFigures/IntermediateFiles/int_med_prec_inv_r2_2.csv',index = False)

#%%
import numpy as np
def prec_count(df,file):
    
    df = df[df['Run']==file]
    pg_count = len(df['Precursor.Id'].unique())
    return pg_count
...
for file in col1_dil:
    temp_count.append(prec_count(report,file))
...
dil_r2_1 = read_file('C:/Users/nlancaster/OneDrive - UW-Madison/MultiColumnManuscript/ManuscriptDraft/PythonFigures/IntermediateFiles/int_med_prec_dil_r2_1.csv')
dil_r2_2 = read_file('C:/Users/nlancaster/OneDrive - UW-Madison/MultiColumnManuscript/ManuscriptDraft/PythonFigures/IntermediateFiles/int_med_prec_dil_r2_2.csv')
inv_r2_1 = read_file('C:/Users/nlancaster/OneDrive - UW-Madison/MultiColumnManuscript/ManuscriptDraft/PythonFigures/IntermediateFiles/int_med_prec_inv_r2_1.csv')
inv_r2_2 = read_file('C:/Users/nlancaster/OneDrive - UW-Madison/MultiColumnManuscript/ManuscriptDraft/PythonFigures/IntermediateFiles/int_med_prec_inv_r2_2.csv')
...
# ax1Left.ticklabel_format(axis = 'y',style = 'sci',scilimits = (0,0))
# ax1Right.ticklabel_format(axis = 'y',style = 'sci',scilimits = (0,0))
...
ax1Left.set_ylabel('Precursors',fontsize = 10)
ax1Left.legend(frameon = True,fontsize = 10,ncol = 1, loc = [0.35,0.01],handletextpad = 0.2,
...
ax1Right.set_ylabel('Precursors',fontsize = 10)
ax1Right.legend(frameon = True,fontsize = 10,ncol = 1, loc = [0.15,0.01],handletextpad = 0.2,
           columnspacing = 0.5, handlelength = 1, labelspacing = 0.2,borderpad = 0.1)


ax1Left.tick_params(axis = 'both',labelsize = 10)
ax1Right.tick_params(axis = 'both',labelsize = 10)
ax1Left.set_ylim(0,190000)
ax1Right.set_ylim(0,190000)
...
for file in file_list:
    x_temp, y_temp = prep_data(prec_pivot['Precursor.Quantity']['[0.0]' + file],
          prec_pivot['Precursor.Quantity']['[4.0]' + file])
...
for i,file in enumerate(file_list_direct):
    x_temp, y_temp = prep_data(prec_pivot['Precursor.Quantity']['[0.0]' + file],
          prec_pivot['Precursor.Quantity']['[0.0]' + file_list_inverse[i]])
...
ax3.set_xlabel('Log2 (Column 1 Peak Area)',fontsize = 10)
ax3.set_ylabel('Log2 (Column 2 Peak Area)',fontsize = 10)
ax3.set_xlim([5,43])
ax3.set_ylim([5,43])
...
ax4.set_xlim([5,43])
ax4.set_ylim([5,43])
ax4.set_xlabel('Log2 (Direct Series Peak Area)',fontsize = 10)
ax4.set_ylabel('Log2 (Inverted Series Peak Area)',fontsize = 10)
...
fig.savefig('C:/Users/nlancaster/OneDrive - UW-Madison/MultiColumnManuscript/ManuscriptDraft/PythonFigures/20250612_Rd07_PrecQuantPerformance_v3.svg',dpi = 1000)
